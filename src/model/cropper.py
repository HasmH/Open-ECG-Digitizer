...
class Cropper(torch.nn.Module):
    def __init__(
        ...
        Args:
            ...
            vertical_padding_fraction (float): Extra space added above and below the detected quadrilateral, as a
                fraction of its left and right edge heights.
        """
    ...
    def _add_vertical_padding(self, source_points: torch.Tensor, height: int, width: int) -> torch.Tensor:
        """Extend both side edges while retaining the detected perspective."""
